...
function init(){
    ...
    $('#pass1').on('blur', function(){
       ...
       clave1 = document.formulario.pass.value
       clave2 = document.formulario.pass1.value
	...
	$.post("../ajax/usuario.php?op=selectInstitucion", function(r){
	...
	$('#mcambio').addClass("treeview active");
...
function guardaryeditar(e)
{
	...
	$.ajax({
		url: "../ajax/especial.php?op=guardaryeditar",
	    type: "POST",
	    data: formData,
	    contentType: false,
	    processData: false,
