                  ...
                  <div class="box">
                    ...
                    <div class="panel-body" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12" id="cursos">
                            <label>Curso:</label>
                            <select class="form-control select-picker" name="curso" id="curso" required>
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12" id="ocultar">
                            <label>Clave (*):</label>
