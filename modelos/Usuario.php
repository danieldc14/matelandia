...
Class Usuario
{
   ...
   public function listarC()
	...
	public function insertar($nombre,$tipo_documento,$num_documento,$direccion,$telefono,$email,$login,$clave,$imagen,$permisos,$cargo,$curso)
	{
         $sql1="SELECT max(idusuario) as id from usuario";
        ...
        $id=$id+1;
		$sql="INSERT INTO usuario (idusuario,nombre,tipo_documento,num_documento,direccion,telefono,email,cargo,login,clave,imagen,condicion,curso)
		VALUES ('$id','$nombre','$tipo_documento','$num_documento','$direccion','$telefono','$email','$cargo','$login','$clave','$imagen','1','$curso')";
		//return ejecutarConsulta($sql);
